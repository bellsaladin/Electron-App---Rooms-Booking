...
var ordersStore = new DevExpress.data.ArrayStore(orders);
...
$("#headerFilter").dxCheckBox({
    text: "Header Filter",
    value: dataGrid.option("headerFilter.visible"),
    onValueChanged: function(data) {
        dataGrid.clearFilter();
...
$("#column-lines").dxCheckBox({
    ...
    value: dataGrid.option("showColumnLines"),
    onValueChanged: function(data) {
...
$("#row-lines").dxCheckBox({
    text: "Show Row Lines",
    value: dataGrid.option("showRowLines"),
    onValueChanged: function(data) {
...
$("#show-borders").dxCheckBox({
    text: "Show Borders",
    value: dataGrid.option("showBorders"),
    onValueChanged: function(data) {
...
$("#row-alternation").dxCheckBox({
    ...
    value: dataGrid.option("rowAlternationEnabled"),
    onValueChanged: function(data) {
